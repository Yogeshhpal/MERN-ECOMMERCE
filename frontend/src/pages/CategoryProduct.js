...
const CategoryProduct = () => {
    ...
    const fetchData = async () => {
        ...
        // console.log("dataResponse from CategoryProduct : ", dataResponse);
    };
    ...
    useEffect(() => {
        ...
        navigate(arrayOfCategory.length > 0 ? `/product-category?${urlFormat}` : "/product-category");
    }, [selectCategory]);
        ...
        <div className='container mx-auto p-4'>
            ...
            <div className='hidden lg:grid grid-cols-[200px,1fr]'>
                ...
                <div className='bg-white p-2 min-h-[calc(100vh-120px)] overflow-y-scroll'>
                    {/* Sort By  */}
                    <div>
                        <h3 className='text-base uppercase font-medium text-slate-500 border-b border-slate-300'>Sort By</h3>
                    ...
                    {/* Filter By  */}
                    <div>
                        <h3 className='text-base uppercase font-medium text-slate-500 border-b border-slate-300'>Category</h3>
                        <form className='text-sm flex flex-col gap-2 py-2'>
